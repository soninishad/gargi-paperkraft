...
<div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                      <h1 style="color: #adc33c;"><span class="site-text-primary">Flat-Bottom  </span>Bags</h1>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box">
                                    <div class="wt-media text-primary m-b20 radius-bx circle-effect-1">
                                       <a href="flat-bottom-bags"><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;" class="radius-bx"  alt=""></a>
                                    </div>
                                    <div class="wt-info p-t30 text-center">
                                        <h4 class="m-b0"><a href="flat-bottom-bags"><?php echo $row['name']; ?></a></h4><br>
                                         ...
                                         <a href="flat-bottom-bags" target="_blank"  class="m-b0" style="text-align: center; fornt-size: 20px;">View Flat Bottom Portfolio</a>
                                    </div>
                                </div>
                            </div>
              <?php
...
<div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                <div class="container">
                    <!-- TITLE START-->
                    <div class="section-head text-center">
                      <h1 style="color: #adc33c;"><span class="site-text-primary">V-Bottom  </span>Bags</h1>
                        <div class="wt-separator-outer ">
                            <div class="wt-separator style-icon">
                                <i class="fa fa-leaf text-black"></i>
                                <span class="separator-left bg-primary"></span>
              ...
              $a=1;
               ...
               ?>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box">
                                    <div class="wt-media text-primary m-b20 radius-bx circle-effect-1">
                                       <a href="v-bottom-bags"><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;" class="radius-bx"  alt=""></a>
                                    </div>
                                    <div class="wt-info p-t30 text-center">
                                        <h4 class="m-b0"><a href="v-bottom-bags"><?php echo $row['name']; ?></a></h4><br>
                                         <h4 class="m-b0"><a href="https://api.whatsapp.com/send?phone=919918280347" >
                                            <img src="images/whatsappicon_gargi_paperkraft_lko.png" style="width: 90px; height: auto;"></a></h4><br>
                                         <a href="v-bottom-bags" target="_blank"  class="m-b0" style="text-align: center; fornt-size: 20px;">View V Bottom Portfolio</a>
                                    </div>
                                </div>
                            </div>
              <?php
