...
$sq="select * from v_bottom where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE v_bottom SET name='$name',  image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_v_bottom_bags";';
        echo '</script>';
