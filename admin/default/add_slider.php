                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <form action="insert_slider.php" method="post" enctype="multipart/form-data">
                                                  <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Heading</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading" id="heading" onpaste="return false" class="form-control" placeholder="heading">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Sub-Heading</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading1" id="heading1" onpaste="return false" class="form-control" placeholder="sub-heading">
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Paragraph</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph" id="paragraph" onpaste="return false" class="form-control" placeholder="paragraph">
                                                    </div>
                                                </div>
                                              <div class="form-group row">
                                              ...
                                              <button type="submit"name="submit" class="btn btn-primary waves-effect waves-light add">Submit</button>
                                           </form>
                                                <br>
                                                <h2><a href="viewslider.php">Click Here To Manage</a></h2>
