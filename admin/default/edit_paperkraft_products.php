...
$sq="select * from industrial where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    if($file_loc)
     ...
     $sq1="UPDATE industrial SET heading='$heading', paragraph='$paragraph', image='$file' where id='$id'";

      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_paperkraft_products";';
        echo '</script>';
     ...
     $sq1="UPDATE industrial SET heading='$heading', paragraph='$paragraph' where id='$id'";
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Edit PaperKraft Products</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading" id="heading" onpaste="return false" class="form-control" value="<?php echo $fet['heading'];?>" placeholder="heading">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Name of Product</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph" onpaste="return false" id="paragraph" class="form-control" value="<?php echo $fet['paragraph'];?>" placeholder="paragraph">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="file" name="file"  class="form-control" value="<?php echo $fet['image'];?>">
                                                    </div>
                                                </div>
