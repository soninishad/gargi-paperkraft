...
$sq="select * from social_media where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $sq1="UPDATE social_media SET  facebook='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_social_media.php";';
        echo '</script>';
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <img src="../../upload/<?php echo $fet['facebook'];?>" width="150" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Upload Image</label>
                                                    <div class="col-sm-10">
                                                        <input type="file" name="file" accept="image/png, image/jpg, image/jpeg" class="form-control" value="<?php echo $fet['facebook'];?>">
                                                    </div>
                                                </div>
