...
$sq="select * from services where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE services SET heading='$heading', paragraph='$paragraph',image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_services.php";';
        echo '</script>';
     ...
     $sq1="UPDATE services SET heading='$heading', paragraph='$paragraph', where id='$id'";
