                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                             <form action="header_insert.php" method="post" >
                                              
                                               <div class="form-group row">
                                                 <div class="form-field col-md-6 form-m-bttm">
                                                    <input name="email_id" id="email_id" type="text" onpaste="return false" placeholder="Email_id *" class="form-control required email">
                                                </div>
                                                <div class="form-field col-md-6">
                                                    <input name="contact_number" id="contact_number" type="text" onpaste="return false" placeholder="contact_number *" class="form-control required">
                                                </div>
                                            </div>
