                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                             <form action="social_media_insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Upload facebook</label>
                                                    <div class="col-sm-10">
