                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Create New PaperKraft Products</h5>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Add PaperKraft Product</h5>
                                            </div>
                                            <div class="card-block">
                                             <form action="paperkraft_products_insert.php" method="post" enctype="multipart/form-data">
                                                
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Category</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading" onpaste="return false" id="heading" class="form-control" placeholder="heading">
                                                    </div>
                                                </div>
