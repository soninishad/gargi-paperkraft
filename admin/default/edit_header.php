...
$sq="select * from header where id='$id'";
...
if(isset($_POST['upload'])){
     ...
     $sq1="UPDATE header SET email_id='$email_id', contact_number='$contact_number' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_header.php";';
        echo '</script>';
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="email_id" id="email_id" class="form-control" value="<?php echo $fet['email_id'];?>" placeholder="email_id">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Contact_number</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="contact_number" onpaste="return false" id="contact_number" class="form-control" value="<?php echo $fet['contact_number'];?>" placeholder="contact_number">
                                                    </div>
                                                </div>
