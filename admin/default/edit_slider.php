...
if(isset($_POST['upload'])){
    ...
    $sq1="UPDATE slider SET heading='$heading', sub_heading='$sub_heading', paragraph='$paragraph',image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_slider.php";';
        echo '</script>';
     ...
     $sq1="UPDATE slider SET heading='$heading', paragraph='$paragraph' where id='$id'";
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading" id="heading" onpaste="return false" class="form-control" value="<?php echo $fet['heading'];?>" placeholder="Name">
                                                    </div>
                                               
                                                </div>

                                                 <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Sub_Heading</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading1" id="heading1" onpaste="return false" class="form-control" value="<?php echo $fet['sub_heading'];?>" placeholder="Sub_Heading">
                                                    </div>
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph" id="paragraph" onpaste="return false" class="form-control" value="<?php echo $fet['paragraph'];?>" placeholder="Paragraph">
                                                    </div>
