...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE team SET name='$name', designation='$designation', image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_team.php";';
        echo '</script>';
     ...
     $sq1="UPDATE team SET name='$name', designation='$designation' where id='$id'";
