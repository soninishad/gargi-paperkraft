                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Flutter</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                             <form action="flutter_insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Area</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="area" id="area" onpaste="return false" class="form-control" placeholder="area">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">City_Name</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="city_name" id="city_name" onpaste="return false" class="form-control" placeholder="city_name">
                                                    </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Pincode</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="pincode" id="pincode" onpaste="return false" class="form-control" placeholder="pincode">
                                                    </div>
                                                     </div>
                                                    <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">State</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="state" id="state" onpaste="return false" class="form-control" placeholder="state">
                                                    </div>
                                                    </div>
