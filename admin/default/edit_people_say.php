...
$sq="select * from people_say where id='$id'";
...
if(isset($_POST['upload'])){
    $file =$_FILES['file']['name'];
     ...
     $sq1="UPDATE people_say SET name='$name', designation='$designation', paragraph='$paragraph',image='$file' where id='$id'";

      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="list_people_say.php";';
        echo '</script>';
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="name" id="name" onpaste="return false" class="form-control" value="<?php echo $fet['name'];?>" placeholder="Name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Designation</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="designation" onpaste="return false" id="designation" class="form-control" value="<?php echo $fet['designation'];?>" placeholder="Designation">
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
