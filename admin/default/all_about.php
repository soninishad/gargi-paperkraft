                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-breakpoints="xs">Paragraph</th>
                                                             <th data-breakpoints="xs">Sub_Paragraph</th>
...
?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['sub_paragraph']?></td>
                                                            <td>
                                                                <a href="edit_about.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>

                                                            <td>
                                                                <a href="delete_about.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Delete</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
