...
$sq="select * from square_bottom_design where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE square_bottom_design SET name='$name',  image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_square_bottom_design";';
        echo '</script>';
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Edit Square Bottom Portfolio</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
