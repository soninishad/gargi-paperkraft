                                                ...
                                                <table id="demo-foo-filtering" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-breakpoints="xs">Profile Picture</th>
...
?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="../../upload/<?php echo $row['image'] ?>" style="width: 50px; height: 50px;" alt="Anch-Meta" class="img-fluid"></td>
                                                            <td><?php echo $row['account_name'] ?></td>
                                                            <td><?php echo $row['username']?></td>
                                                            <td>
                                                                <a href="edit_admin_account.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
