...
$sq="select * from flat_bottom_design where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE flat_bottom_design SET name='$name',  image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_flat_bottom_design";';
        echo '</script>';
                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Edit Flat Bottom Portfolio</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Flat Bottom Portfolio</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">P_Name</label>
                                                    <div class="col-sm-10">
                                                 ...
                                                 <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">P_Image</label>
                                                    <div class="col-sm-10">
                                                        <img src="../../upload/<?php echo $fet['image'];?>" width="150" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Upload P_Image</label>
                                                    <div class="col-sm-10">
