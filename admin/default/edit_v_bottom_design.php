...
$sq="select * from v_bottom_design where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE v_bottom_design SET name='$name',  image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_v_bottom_design";';
        echo '</script>';
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">V Bottom Portfolio</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
