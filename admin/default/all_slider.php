                                                ...
                                                <table id="demo-foo-filtering" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-breakpoints="xs">Sub_Heading</th>
                                                            <th data-breakpoints="xs">Paragraph</th>
...
<?php
    include "../../connection.php";
    $query="select * from slider ORDER BY  image ASC";
...
?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit_slider.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>

                                                            <td>
                                                                <a href="delete_slider.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Delete</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
