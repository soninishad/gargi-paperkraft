...
<head>
     <link rel="shortcut icon" href="anch.png">
    <meta charset="utf-8">
                                             ...
                                             <form action="about_insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph" onpaste="return false" id="paragraph" class="form-control" placeholder="paragraph">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Sub_Paragraph</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph1" onpaste="return false" id="paragraph1" class="form-control" placeholder="paragraph">
                                                    </div>
                                                </div>
