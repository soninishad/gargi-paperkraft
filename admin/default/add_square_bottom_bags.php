                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                             <form action="square_bottom_bags_insert.php" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">P_Name</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="name" id="name" onpaste="return false" class="form-control" placeholder="Name">
                                                    </div>
                                                </div>
