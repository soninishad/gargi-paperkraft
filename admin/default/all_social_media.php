                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Social_media</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-block">
                                                ...
                                                <table id="demo-foo-filtering" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th data-breakpoints="xs">Facebook</th>
...
?>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $a ?></td>
                                                            <td><img src="../../upload/<?php echo $row['facebook'] ?>" alt="image" width="45px" height="45px"  style="border-radius: 25px;"/></td>
                                                
                
                                                            <td>
                                                                <a href="edit_social_media.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>

                                                            <td>
                                                                <a href="social_media_delete.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Delete</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
