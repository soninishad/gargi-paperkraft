...
?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit_clients.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>

                                                            <td>
                                                                <a href="clients_delete.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Delete</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
