...
$sq="select * from square_bottom where id='$id'";
...
if(isset($_POST['upload'])){
    ...
    $file_loc = $_FILES['file']['tmp_name'];
     ...
     $sq1="UPDATE square_bottom SET name='$name',  image='$file' where id='$id'";


      if(mysqli_query($conn,$sq1)){
        echo '<script language="javascript">';
        echo 'alert("Your Content successfully Updated");';
        echo 'window.location.href="all_square_bottom_bags";';
        echo '</script>';
                                ...
                                <div class="col-lg-4">
                                    <div class="page-header-breadcrumb">
                                        <ul class=" breadcrumb breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!">Square Bottom Bags</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
