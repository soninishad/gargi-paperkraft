                                                ...
                                                <table id="demo-foo-filtering" class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-breakpoints="xs">Designation</th>
...
?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="edit_people_say.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Edit</button></a>
                                                            </td>

                                                            <td>
                                                                <a href="people_delete_delete.php?id=<?php echo $row['id'];?>"><button type="button" class="btn btn-primary waves-effect waves-light add">Delete</button></a>
                                                            </td>
                                                        </tr>
<?php
++$a;
