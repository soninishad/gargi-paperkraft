...
$sq="select * from about where id='$id'";
...
if(isset($_POST['upload'])){
      ...
      $sub_paragraph=$_POST['sub-paragraph'];
     ...
     $sq1="UPDATE about SET heading='$heading', paragraph='$paragraph', sub_paragraph='$sub_paragraph',   where id='$id'";
      ...
      if(mysqli_query($conn,$sq1)){
        ...
        echo 'window.location.href="all_about";';
        echo '</script>';
                                            ...
                                            <div class="card-block">
                                             <form action="" method="post" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="heading" id="heading"  class="form-control" value="<?php echo $fet['heading'];?>" placeholder="heading">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">paragraph</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph"  id="paragraph" class="form-control" value="<?php echo $fet['paragraph'];?>" placeholder="paragraph">
                                                    </div>
                                                </div>
                                                 <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Sub_paragraph</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="paragraph1"  id="paragraph1" class="form-control" value="<?php echo $fet['paragraph'];?>" placeholder="sub_paragraph">
                                                    </div>
                                                </div>
